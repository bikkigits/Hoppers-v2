...
export const BottomNav: React.FC<Props> = ({
  ...
  return (
    <nav
      ...
      className="fixed bottom-3 left-3 right-3 z-30 max-w-lg mx-auto pointer-events-auto"
      role="navigation"
      aria-label="Main Navigation"
    >
      <div className="flex items-center justify-between p-1.5 rounded-2xl bg-slate-900/90 backdrop-blur-xl border border-white/15 shadow-2xl shadow-black/80">
        {tabs.map((tab) => {
        ...
        <button
          id="dock-sos-btn"
          onClick={onOpenSOS}
          className="flex flex-col items-center justify-center px-2.5 py-2 rounded-xl bg-gradient-to-br from-red-600 to-red-700 text-white font-black shadow-lg shadow-red-600/30 hover:brightness-110 active:scale-95 transition-all shrink-0 min-h-[46px] ml-1 border border-red-400/40 animate-pulse"
          title={t.sosButton}
        >
